...
class Contact extends React.Component {
        ...
        render() {
            return ( <
                div className = "container" > < h2 > Table des données(CRUD) des voyageurs < /h2> <
                p > < Link to = "/create"
                className = "btn btn-primary btn-xs" > Ajouter voyageur < /Link> </p >
                <
                ...
                /thead> <
                tbody > {
                    this.state.reservation.map(function(item, key) {
                            return ( <
                                tr key = { key } >
                                <
                                td > { item.id } < /td> <
                                ...
                                className = "btn btn-primary btn-xs" > Modifier < /Link>

                                <
                                Link to = "#"
                                onClick = { this.deleteContact.bind(this, item.id) }
                                className = "btn btn-danger btn-xs" > Supprimer < /Link> < /
                                td > <
                                /tr>)
                            }.bind(this))
                    } <
